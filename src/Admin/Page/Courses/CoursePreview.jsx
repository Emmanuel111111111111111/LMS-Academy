    ...
    return (
        <>
            ...
            <div className={styles.whole}>
                ...
                <div className={styles.breadcrumb}><a href="/admin-dashboard/courses">Courses</a> {'>'} <a onClick={()=>navigate(`/admin-dashboard/courses/detail/${course.course_id}`)}>{course ? course.course_name : 'NA'}</a> {'>'} Preview</div>
                                ...
                                <div>
                                    ...
                                    <div className={styles.titleInfo}>
                                        ...
                                        <div className={styles.stud}>
                                            ...
                                            {course.student_count} Registered student{course.student_count != 1 && `s`}
                                        </div>
                                    </div>
