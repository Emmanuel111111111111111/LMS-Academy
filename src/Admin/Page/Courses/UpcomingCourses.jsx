...
export const UpcomingCourses = () => {
    ...
    const fetchCoursesTeachersStudents = async () => {
        ...
        try {
            ...
            setCourses(result.data.filter(e => e.is_active === null));
            setIsLoading(false);
        } catch (err) {
            console.log(err);
            setIsLoading(false);
    ...
    return (
        ...
        <div className={styles.whole}>
            ...
            <div className={styles.breadcrumb}><a href="/admin-dashboard/overview">Home</a> {'>'} <a href="/admin-dashboard/courses">Courses</a> {'>'} Upcoming</div>
                        ...
                        <div className={styles.text}>
                            <div className={styles.Header}>
                                <h3>
                                    ...
                                    {selected.suspended ? <span className={styles.susp}>Suspended</span> : ''}
                                </h3>
                            </div>
